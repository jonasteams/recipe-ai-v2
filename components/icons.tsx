...
export const FilledHeartIcon: React.FC<{className?: string}> = ({ className }) => (
...
export const FireIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-5 w-5"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12c2-2.96 0-7-1-8 0 3.038-1.773 4.741-3 6-1.227 1.26-2 3.24-2 5a6 6 0 1 0 12 0c0-1.532-1.03-3.9-2-5-1.786 1-3.647 1-4-2Z" />
    </svg>
);
